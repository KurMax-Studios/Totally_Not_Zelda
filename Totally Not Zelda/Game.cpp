...
Game::Game(void) : m_mapRenderer(m_map), m_playerRenderer(m_player), m_enemyRenderer(m_enemyManager), m_playerController(m_player, m_options), m_collisionManager(m_player, m_map, m_enemyManager)
{
